...
public class Spawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _nativeAltar.Init(_allLvls.GetCurrentLvl().AltarModel);
    ...
    private void SpawnEnemy(Enemy enemy, SpawnPosition spawnPosition, int enemyLvl)
    {
        ...
        spawnedEnemy.SetEnemyLvl(enemyLvl);
    ...
    public void StartCelebration()
    {
        ...
        {
            if (_enemies[i] != null)
                _enemies[i].Celebration.Invoke(_enemies[i]);
        }
    }
    public void RestartByReward()
    {
        KillAllUnits();
        _currentState = SpawnState.COUNTING;
    }
